...
export default function AboutPage() {
  return (
    <div className="pt-20">
      ...
      {/* ── Page header ── */}
      <div className="relative bg-dark-ui py-24 overflow-hidden">
              ...
              >
                ...
                <div className={`md:col-span-1 ${idx % 2 === 1 ? 'md:order-last' : ''}`}>
                  <div className="relative rounded-2xl overflow-hidden shadow-md bg-warm-bg aspect-[4/5]">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-dark-ui/80 to-transparent p-5">
      ...
      {/* ── YouTube & CTA ── */}
      <section className="py-20 bg-dark-ui relative overflow-hidden">
        {/* ひょっこりバッハ — さりげなく右隅に */}
        <div
